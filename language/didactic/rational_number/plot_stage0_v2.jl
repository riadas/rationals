...
task_dict = Dict([
    ...
    "is_a_number_task" => (is_a_number_task, 1), # MODIFY
    "arithmetic_task" => (arithmetic_task, 20), # MODIFY
    ...
    for i in 1:length(language_names)
        ...
        for j in 1:length(language_names)
            ...
            if dist == 0
                ...
                # if !l1_spec["infinite_divisibility_number"] && l2_spec["infinite_divisibility_number"] && !l1_spec["infinite_divisibility_space"]
                #     transition_prob = 0
                # end
