...
function halve()
    RN(1, 2) # INCOMPLETE: RationalNumber(1, 2)
end

function halve(n::NaturalNumber)
    RN(n, 2) # INCOMPLETE: RationalNumber(n, 2)
end

function halve(rn::RationalNumber)
    RN(rn.numerator, rn.denominator * 2) # INCOMPLETE: RationalNumber(rn.numerator, rn.denominator * 2) # halve_obj(PhysicalObject(rn)).size
end

function double(rn::RationalNumber)
     RN(rn.numerator*2, rn.denominator) # INCOMPLETE: RationalNumber(rn.numerator*2, rn.denominator)
end

function divide(n::NaturalNumber)
    RN(1, n) # INCOMPLETE: RationalNumber(1, n)
end

function divide(rn::RationalNumber, n::NaturalNumber)
    RN(rn.numerator, rn.denominator * n) # INCOMPLETE: RationalNumber(rn.numerator, rn.denominator * n) # split_obj(PhysicalObject(rn), n).size
end

function multiply(rn::RationalNumber, n::NaturalNumber)
    RN(rn.numerator*n, rn.denominator) # INCOMPLETE: RationalNumber(rn.numerator*n, rn.denominator) # combine_obj(PhysicalObject(rn), n).size
end
...
function divide(n::NaturalNumber, m::NaturalNumber)
    ...
    # RationalNumber(n, m) 
    RN(n, m) # INCOMPLETE: cast_NN((divide_obj(PhysicalObject(1), n, m)).size)
end
...
function nn_intrusion_compare(arg1::RationalNumber, arg2::RationalNumber, operator::Symbol)
    if arg1.denominator == arg2.denominator
        eval(operator)(arg1.numerator, arg2.numerator)
    elseif arg1.numerator == arg2.numerator 
        eval(operator)(arg1.denominator, arg2.denominator)
    else
        NullNumber
    end
end
...
function multiply(arg1::RationalNumber, arg2::RationalNumber)
    RN(arg1.numerator * arg2.numerator, arg1.denominator * arg2.denominator) # INCOMPLETE: divide(multiply(arg1, arg2.numerator), arg2.denominator)
end

function divide(arg1::RationalNumber, arg2::RationalNumber)
    RN(arg1.numerator * arg2.denominator, arg1.denominator * arg2.numerator) # INCOMPLETE: divide(multiply(arg1, arg2.denominator), arg2.numerator)
end
